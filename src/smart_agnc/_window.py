...
class _Window(gtk.Window):
    """
    Abstract Window class that predefines the behaviour of every window. It lets
    you close with Esc and submit with Return. It also adds a new signal called
    `form_submit` to handle the Return key.
    """
...
gobject.signal_new('form_submit', _Window, gobject.SIGNAL_RUN_CLEANUP, None, ())
